...
const doubleReverseData = [
  {
    ...
    lr: [16+8, 60-21, 225, 0.3, 'bottom', 'all 2s'],
  },
  {
    type: 'percent',
    text: [
  ...
  },
  {
    ...
    mr: [22, -50, -90, 0.7, 'top', 'all 3s'],
    ll: [12, -45, -135, 0.7, 'top', 'top 3s, left 3s, opacity 2s 1s, transform 2.75s 0.25s'],
    lr: [0, 0, -90, -0.7, 'bottom', 'top 3s, left 3s, opacity 2s 1s, transform 2s 1s'],
  },
  {
    type: 'percent',
    text: [
    ...
    ml: [28, -25, -135, 0, 'top', 'left 2s, top 3s, opacity 3s, transform 2.25s 0.75s'],
    mr: [0, 0, -135, 0, 'top', 'left 2s, top 2s, opacity 3s, transform 2.25s 0.75s'],
    ll: [0, 0, 0, -0.7, 'top', 'all 2.25s 0.75s'],
    lr: [22, 8, -90, 0.7, 'bottom', 'all 2.25s 0.75s'],
  },
  {
    type: 'percent',
    text: [
...
const reversePivotData = [
  {
    ...
    mr: [25, 36, 270, 0.3, 'top', 'all 2s'],
    ll: [20, 32, 90, 0.3, 'top', 'all 2s'],
...
const waltz_all_figures = [
  ...
  new Figure('Weave from Promenade', 'Waltz', 'Silver', 'Standard', chasse_to_right_data),
  new Figure('Closed Telemark', 'Waltz', 'Silver', 'Standard', chasse_to_right_data),
  ...
  new Figure('Cross Hesitation', 'Silver', 'Silver', 'Standard', chasse_to_right_data),
