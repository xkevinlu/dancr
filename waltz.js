const natural_turn_data = [
  ...
  },
  {
    ...
    ml: [155, 165, 90, 0.8, 'center', 'all 1.2s cubic-bezier(0.55, 0.085, 0.68, 0.53)', 'T'],
    mr: [0, 0, 90, -0.8, 'top', 'all 1.2s ease, transform 0.7s 0.5s cubic-bezier(0.55, 0.085, 0.68, 0.53)'],
    ll: [0, 0, 0, -0.8],
    lr: [70, 120, 135, 0.8, 'center', 'all 1.2s cubic-bezier(0.55, 0.085, 0.68, 0.53)', 'T'],
  },
  {
    text: [
      '3',
...
const reverse_turn_data = [
  ...
  },
  {
    ...
    ml: [mdStep, -mdStep, -45, 0.8, '', '', 'HT'],
    mr: [0, 0, 0, -0.8],
    ll: [0, 0, 0, -0.8],
    lr: [smStep, -lgStep, -45, 0.8, '', '', 'HT'],
  },
  {
    text: [
      '2. Moving together towards LOD',
    ...
    ml: [0, 0, 0, -0.8],
    mr: [180, 2 * (-lgStep)-10, -90, 0.8, '', '', 'T'],
    ll: [2 * smStep, 2 * (-lgStep), -135, 0.8, '', '', 'T'],
    lr: [0, 0, 0, -0.8],
  },
  {
    text: [
...
const spin_turn_data = [
  ...
  },
  {
    ...
    ml: [smStep, xsStep, 22.5, 0.8, 'top', '', 'THT'],
    mr: [0, 0, 0, -0.8],
    ll: [0, 0, 0, -0.8, 'top', 'all 2s'],
    lr: [lgStep, xsStep, 0, 0.8, 'top', '', 'HT'],
  },
  {
    text: [
      '2. Moving together towards LOD',
    ...
    mr: [xlStep, mdStep, 180, 0.8, 'center', '', 'HT'],
    ll: [2*lgStep+20, xlStep, 180, 0.8, 'top', 'left 2s,  top 1.8s ease-in,  opacity 2s,  transform 2s', 'T'],
    lr: [0, 0, 180, -0.8, 'top'],
  },
  {
    text: [
    ...
    ml: [mdStep, -xlStep-10, 45, 0.8, '', '', 'TH'],
    mr: [0, 0, 45, -0.8],
    ll: [0, 0, 45, -0.8, 'top'],
    lr: [mdStep, -smStep-10, 45, 0.8, '', '', 'TH'],
  },
  {
    text: [
      '3&. Collecting weight under body',
...
const chasse_from_promenade_data = [
  ...
  },
  {
    ...
    ml: [0, 0, 0, -0.8],
    mr: [smStep, 0, 0, 0.8, '', '', 'HT'],
    ll: [smStep, 0, 0, 0.8, '', '', 'HT'],
    lr: [0, 0, 0, -0.8],
  },
  {
    text: [
    ...
    ml: [2*lgStep, 0, 0, 0.8, '', '', 'T'],
    mr: [0, 0, 0, -0.8],
    ll: [0, 0, 0, -0.8],
    lr: [2*xlStep, -xsStep, -90, 0.8, '', '', 'T'],
  },
  {
    text: [
      '2&. Collect & change weight',
      '2&. RF closes to LF (T),  cont. to rise',
      '2&. LF closes to RF (T),  cont. to rise',
    ],
    ml: [0, 0, 0, -0.8],
    mr: [mdStep, 0, 0, 0.8, '', '', 'T'],
    ll: [xlStep, 0, -90, 0.8, '', '', 'T'],
    lr: [0, 0, 0, -0.8],
  },
  {
    text: [
    ...
    ml: [mdStep, 0, 0, 0.8, '', '', 'T&H'],
    mr: [0, 0, 0, -0.8],
    ll: [0, 0, 0, -0.8],
    lr: [mdStep, 0, 0, 0.8, '', '', 'T&H'],
  },
  {
    text: [
      '3&.',
...
const closedImpetusData = [
  ...
  },
  {
    ...
    ml: [15, 15, 45, 0.8, 'bottom', 'all 1.5s', 'TH'],
    mr: [0, 0, 0, -0.8, 'top', 'all 1.5s'],
    ll: [0, 0, 0, -0.8, 'top', 'all 1.5s'],
    lr: [22, 4, 0, 0.8, 'top', 'all 1.5s', 'HT'],
  },
  {
    type: 'percent',
    text: [
    ...
    ml: [0, 0, 90, -0.8, 'bottom', 'left 1.5s, top 1.5s, opacity 1.5s, transform 1.25s 0.25s', 'TH'],
    mr: [40, 19, 135, 0.8, 'top', 'left 1.5s, top 1.25s cubic-bezier(.35,-0.4,.56,1.01), opacity 1.5s, transform 1.5s'],
    ll: [50, 25, 135, 0.8, 'top', 'all 1.5s', 'T'],
  ...
  },
  {
    ...
    ml: [-10, -45, 90, 0.8, 'bottom', 'all 3s', 'TH'],
    mr: [0, 0, 90, -0.8, 'top', 'all 3s'],
    ll: [0, 0, 90, -0.8, 'top', 'all 2.7s 0.2s'],
    lr: [-17, -24, 90, 0.8, 'top', 'all 2.7s 0.2s', 'TH'],
  },
  {
    type: 'percent',
    text: [
...
const hesitationChangeData = [
  ...
  },
  {
    ...
    ml: [25, 0, 22.5, 0.8, 'center', 'all 2s', 'TH'],
    mr: [0, 0, 0, -0.8, 'top', 'all 2s'],
    ll: [0, 0, 0, -0.8, 'top', 'all 2s'],
    lr: [30, 2, 0, 0.8, 'top', 'all 2s', 'HT'],
  },
  {
    type: 'percent',
    text: [
